...
import { Bell, ShieldAlert, Info, CheckCircle, Trash2, CheckSquare } from 'lucide-react';
...
export const NotificationDropdown = () => {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger render={<button className="relative p-2 text-[#8E9299] hover:text-white transition-colors flex items-center justify-center cursor-pointer" />}>
            ...
            <div className="flex flex-col">
              {notifications.map((notif) => (
                <div 
                  key={notif.id}
                  className={cn(
                    "flex gap-3 p-3 border-b border-[#2A2C32] last:border-b-0 hover:bg-[#1A1C20] transition-colors relative group",
